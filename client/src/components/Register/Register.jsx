                        ...
                        <div class="max-w-xl lg:max-w-3xl">
                            ...
                            <div class="col-span-6">
                                ...
                                <input
                                    ...
                                    id="Email"
                                    name="email"
                                    class="mt-1 w-full rounded-md border-gray-200 bg-white text-l text-gray-700 shadow-sm"
                            ...
                            <div class="col-span-6 mt-4 sm:flex sm:items-center sm:gap-4">
                                <button
                                ...
                                <p class="mt-4 text-sm text-gray-500 sm:mt-0">
                                    ...
                                    <a href="#" class="text-gray-700 underline">Login</a>.
                                </p>
                            </div>
                        </div>
                    </main>
